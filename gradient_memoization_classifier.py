...
#subprocess.Popen("timeout 50 nvidia-smi --query-gpu=utilization.gpu,utilization.memory --format=csv -l 1 | sed s/%//g > ./5-GPU-stats-gradient-memo.log",shell=True)
...
print(Model.fit_generator.__defaults__)
